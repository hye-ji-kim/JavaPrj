...
private static void inputExam(ObjectCollection list) {
	...
	private static void outputExam(ObjectCollection list) {
		...
		for(int i=0;i<list.size();i++)
		{
			...
			//Exam exam = (Exam)list.get(i); //Object가 나오니까 형변환(범용적으로 사용하기 때문에)
			
			//exam 검사
			Exam exam = null;
			Object obj = list.get(i);
					if(obj instanceof Exam) // obj가 Exam에서 나온게 맞다면
						exam = (Exam)obj; //obj를 Exam으로 형변환 하여 exam에 넣음
